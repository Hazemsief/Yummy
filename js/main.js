...
function showSearch() {
  $("#contactForm").removeClass('vh-100')
  let box = `<div class="d-flex justify-content-center bg-body">
<input id="searchByName" type="text" class="form-control m-4 text-bg-info" placeholder="Search By Name">
<input id="searchByFL" type="text" class="form-control m-4 text-bg-info" placeholder="Search By First Letter">
</div>`
...
<button id="formSubmitBtn" class="btn btn-info" disabled>Submit</button> 
`
